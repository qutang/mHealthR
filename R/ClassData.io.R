#' @name ClassData.io.writeCsv
#' @title Write class data into mhealth folder structure and with mhealth filename convention.
#' @import lubridate stringr
#' @param folder the output folder
#' @param classData the input dataframe that matches mhealth specification.
#' @param classMapName the classMapName for this set of classes
#' @param classMapId the classMapId for this set of annotations
